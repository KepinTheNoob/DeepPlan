...
fun ExternalContextScreen() {
    ...
    val locations = listOf("Personal", "Work", "School", "Hobby")


    var areaTypeExpanded by remember { mutableStateOf(false) }
    var selectedAreaType by remember { mutableStateOf("Personal") }
    val areaTypes = listOf("Personal", "Work", "School", "Hobby")

    var seasonExpanded by remember { mutableStateOf(false) }
    var selectedSeason by remember { mutableStateOf("Individual") }
    val seasons = listOf("Individual", "Company", "Non-profit")
